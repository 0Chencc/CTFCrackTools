...
public class CTFcrack{
    ...
    public void CryptoWindow(){//主窗口
    	...
    	springLayout.putConstraint(SpringLayout.EAST, zip_filename, 400, SpringLayout.WEST, zip_Panel);
    	...
    	springLayout.putConstraint(SpringLayout.EAST, zip_infile, 400, SpringLayout.WEST, zip_Panel);
    	...
    	springLayout.putConstraint(SpringLayout.EAST, zip_filepath, 400, SpringLayout.WEST, zip_Panel);
    	...
    	springLayout.putConstraint(SpringLayout.EAST, zip_selectlabel, 400, SpringLayout.WEST, zip_Panel);
    	...
    	springLayout.putConstraint(SpringLayout.EAST, zip_key, 400, SpringLayout.WEST, zip_Panel);
